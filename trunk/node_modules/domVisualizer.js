...
LeapSystem.prototype.run = function run(document, Leap){
    var obj = this;
    var pool = {};
    ...
    obj.init({'pool': pool, 'scene':scene});
    ...
    Leap.loop(function(frame) {
        ...
        for (var i = 0, hand; hand = hands[i++];) {
            ...
            var node = obj.getNode(hand.id, sphereTemplate);

            obj.move(node, posX, posY, posZ, rotX, rotY, rotZ);
        ...
        for (var i = 0, pointable; pointable = pointables[i++];) {
            ...
            node = obj.getNode(pointable.id, fingerTemplate);

            obj.move(node, posX, posY, posZ, dirX, dirY, dirZ);
